 ...
 */
public class Pay extends Activity implements IabBroadcastReceiver.IabBroadcastListener,
        OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            ...
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(Pay.this);
